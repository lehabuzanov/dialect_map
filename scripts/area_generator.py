            ...
            provisional_isoglosses.append(
                {
                    ...
                    "properties": {
                        ...
                        "title": "Предварительная изоглосса между признаками",
                        "status_note": (
                            "Предварительная линия построена автоматически между двумя "
                            "выбранными признаками и служит только демонстрационной визуализацией."
                        ),
                    },
                    "geometry": {
                        "type": "LineString",
...
def build_geojson_feature(
    ...
    return {
        ...
        "properties": {
            ...
            "source": "auto",
            "scope": scope,
            "title": "Предварительный ареал признака" if is_feature_scope else "Предварительный ареал значения",
            "status_note": (
